...
void BOARD_InitPins(void) {
  ...
  // Set up the multiplexing for the WF200 SPI and GPIO pins
  // WF200 SPI
  IOMUXC_SetPinMux(
  ...
  // WF200 GPIO
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_AD_B0_03_GPIO1_IO03,        /* GPIO_AD_B0_03 is configured as GPIO1_IO03, This reconfigures the use
                                                 LPSPI3_PCS0 as the driver PCS pin to manually asserting/de-asserting
		                                         the PCS pin as required */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_AD_B1_12_GPIO1_IO28,        /* GPIO_AD_B1_12 is configured as GPIO1_IO28, this is used as the WF200
                                                 SPI Data Ready Interrupt pin */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_AD_B1_13_GPIO1_IO29,        /* GPIO_AD_B1_13 is configured as GPIO1_IO29, this is used as the WF200
                                                 RESET pin */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_AD_B1_14_GPIO1_IO30,        /* GPIO_AD_B1_14 is configured as GPIO1_IO30, this is used as the WF200
                                                 WAKEUP pin */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */


  // Set up the pin configuration for the WF200 SPI and GPIO pins
  // WF200 SPI
  IOMUXC_SetPinConfig(
...
///// ##SAT
#ifdef DUMMY // This is a dummy define to keep track of what has been removed
